...
| **III. API & Operations** — data/admin paths follow their conventions; application authority stays two-tier; monitoring uses a dedicated credential; `ARCHITECTURE.md` is updated | ☐ | N/A if no endpoint or auth change |
