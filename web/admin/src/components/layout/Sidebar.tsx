...
import { globalNav, namespaceNav, parsePs1 } from '../../routes/nav'
...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 bg-surface border-r border-default flex flex-col z-40">
