...
export default function MetricTile({ label, value, hint }: MetricTileProps) {
  return (
    <div className="bg-surface border border-default rounded-sm p-4 flex flex-col gap-1.5">
      <span className="font-mono text-xs uppercase tracking-[0.04em] text-secondary">{label}</span>
