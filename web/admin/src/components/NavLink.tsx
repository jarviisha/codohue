...
export default function NavLink({ to, icon, end = false, children }: Props) {
  return (
    <RouterNavLink
      ...
      className={({ isActive }) =>
        `flex h-9 items-center gap-2.5 rounded border px-3 text-sm font-medium no-underline transition-colors duration-150 focus-visible:outline-none focus-visible:shadow-focus ${
          isActive
