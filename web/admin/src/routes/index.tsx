...
import CatalogItemsListPage from '../pages/ns/catalog/items/ListPage'
    ...
    <Routes>
      ...
      <Route element={<AppShell />}>
        ...
        <Route path="ns/:name" element={<NamespaceLayout />}>
          ...
          <Route path="catalog" element={<CatalogConfigPage />} />
          <Route path="catalog/items" element={<CatalogItemsListPage />}>
