...
| Recommendations carry the same `scored` flag | `fallback_popular`, trending and `hybrid_cold` rank by a namespace-wide signal and emit `score: 0`, which read as "irrelevant to this subject" rather than "this response has no personalised score" |
