...
func TestStoreObjectEmbedding_Success(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_embed_1/embedding"
...
func TestStoreObjectEmbedding_Unauthorized(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_embed_2/embedding"
	resp := doRequest(t, http.MethodPut, url, "bad-key", dim4)
...
func TestStoreObjectEmbedding_NoToken(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_embed_2/embedding"
	resp := doRequest(t, http.MethodPut, url, "", dim4)
	assertStatus(t, resp, http.StatusUnauthorized)
	resp.Body.Close()
}

func TestStoreObjectEmbedding_EmptyVector(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_embed_3/embedding"
	resp := doRequest(t, http.MethodPut, url, nsKey, map[string]any{"vector": []float32{}})
...
func TestStoreObjectEmbedding_MissingVector(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_embed_3/embedding"
	resp := doRawRequest(t, http.MethodPut, url, nsKey, `{}`)
	assertStatus(t, resp, http.StatusBadRequest)
	resp.Body.Close()
}
...
func TestStoreObjectEmbedding_DimMismatch(t *testing.T) {
	...
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_embed_4/embedding"
	resp := doRequest(t, http.MethodPut, url, nsKey,
...
func TestStoreSubjectEmbedding_Success(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/subjects/subj_embed_1/embedding"
	resp := doRequest(t, http.MethodPut, url, nsKey, dim4)
	assertStatus(t, resp, http.StatusNoContent)
	resp.Body.Close()
}
...
func TestStoreSubjectEmbedding_Unauthorized(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/subjects/subj_embed_2/embedding"
	resp := doRequest(t, http.MethodPut, url, "bad-key", dim4)
	assertStatus(t, resp, http.StatusUnauthorized)
	resp.Body.Close()
}
...
func TestStoreSubjectEmbedding_DimMismatch(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/subjects/subj_embed_3/embedding"
	resp := doRequest(t, http.MethodPut, url, nsKey,
...
func TestDeleteObject_Success(t *testing.T) {
	...
	storeURL := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_to_delete/embedding"
	store := doRequest(t, http.MethodPut, storeURL, nsKey, dim4)
	assertStatus(t, store, http.StatusNoContent)
	store.Body.Close()

	deleteURL := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_to_delete"
...
func TestDeleteObject_Idempotent(t *testing.T) {
	...
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_never_existed"
...
func TestDeleteObject_Unauthorized(t *testing.T) {
	url := baseURL + "/v1/namespaces/" + testNS + "/objects/obj_embed_1"
